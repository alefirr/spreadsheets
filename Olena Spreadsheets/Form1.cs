...
namespace Olena_Spreadsheets
{
    public partial class Form1 : Form
    {
        ...
        private void SaveDoc()
        {
            ...
            saveFileDialog.Filter = "Olena SpreadSheets (*sprt)|*.sprt";
            saveFileDialog.Title = "Зберегти файл";
            saveFileDialog.FileName = "Таблиця Olena SpreadSheets";
        ...
        private void OpenDoc()
        {
            ...
            try
            {
                ...
                openFileDialog.Filter = "Olena SpreadSheets (*sprt)|*.sprt";
        ...
        {
            string info = "Програма Olena SpreadSheets призначена для роботи з таблицями даних."
